<%@ Page Language="C#" MasterPageFile="~/theme_connect.master"  UnobtrusiveValidationMode="0" AutoEventWireup="true" CodeFile="adminlogin1.aspx.cs" Inherits="adminlogin1" %>

<asp:Content ID="content1" ContentPlaceHolderID="body" runat="server">

    <div style="background-color:azure" class="pt-lg-5; p-4">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    ...
                    <ul class="navbar-nav ml-auto mr-auto" >
                        ...
                        <li class="nav-item">
                            <a href="usersinup.aspx" class="nav-link">user</a>
