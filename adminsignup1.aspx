<%@ Page Language="C#" MasterPageFile="~/theme_connect.master"  UnobtrusiveValidationMode="0" AutoEventWireup="true" CodeFile="adminsignup1.aspx.cs" Inherits="adminsignup1" %>
    ...
    <div class="container bg-light mt-lg-5 mb-lg-5" style="border-radius:8px; box-shadow:10px 10px 10px;">
            ...
            <div class="col-md-4 p-3">
                <asp:TextBox runat="server" ID="emaila" CssClass="form-control"></asp:TextBox>
                <asp:RequiredFieldValidator ID="namev" runat="server" ForeColor="Red" ErrorMessage="email is required" ControlToValidate="emaila"></asp:RequiredFieldValidator>
            </div>
            <div class="col-md-6 p-3">
            ...
            <div class="col-md-4 p-3">
                ...
                <div class="col-md-3 offset-5 m-2">
                    <asp:Button CssClass="form-control bg-warning" runat="server" Text="Login" OnClick="submitadmin" />
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    ...
                    <ul class="navbar-nav ml-auto mr-auto" >
                        ...
                        <li class="nav-item">
                            <a href="adminlogin1.aspx" class="nav-link">login</a>
                        </li>
